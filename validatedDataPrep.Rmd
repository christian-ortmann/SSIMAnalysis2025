...
valData <- read_csv(here("rockfall_mine8_min_binary_validated.csv"))
valData <- data.frame("date" = valData$Date, "timeOfInitiation" = valData$`Time of Initiation`) #re-format a bit

#MINE8
jun <- read_csv(here('jun2022.csv'))
july <- read_csv(here('july2022.csv'))
aug <- read_csv('aug2022.csv')
sept <- read_csv('sept2022.csv')
morenci <- read_csv('morenciWeather2022.csv')
morenci <- morenci[c(1:24190),]
```
